...
public class DiscoveryRuleGetRequest extends RequestBase{
	public DiscoveryRuleGetRequest() {
		super("drule.get");
	}
	private DiscoveryRuleGetParams params = new DiscoveryRuleGetParams();
	public void setParams(DiscoveryRuleGetParams params) {
		this.params = params;
	}
	public DiscoveryRuleGetParams getParams() {
		return params;
	}
	public static class DiscoveryRuleGetParams{
