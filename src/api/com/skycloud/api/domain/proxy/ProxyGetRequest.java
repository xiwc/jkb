...
public class ProxyGetRequest extends RequestBase{
	public ProxyGetRequest() {
		super("proxy.get");
	}
	private ProxyGetParams params = new ProxyGetParams();
	public void setParams(ProxyGetParams params) {
		this.params = params;
	}
	public ProxyGetParams getParams() {
		return params;
	}
	public static class ProxyGetParams{
